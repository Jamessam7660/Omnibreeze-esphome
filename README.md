...
- **OmniBreeze DC2313R Tower Fan** (Costco Item #4333021)
...
Reverse engineered and developed by [@phdindota](https://github.com/phdindota) with assistance from Claude (Anthropic).
